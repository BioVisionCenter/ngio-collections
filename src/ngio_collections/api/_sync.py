...
from ngio_collections.io.store import AsyncReadableStore
...
def open(source: str, store: AsyncReadableStore | None = None) -> Node:
    """Synchronous `open`."""
...
def delete(node: Node, store: AsyncReadableStore | None = None) -> list[str]:
    """Synchronous `delete`."""
