...
def write_well(row: str, col: str) -> ozc.CollectionRef:
    ...
    return ozc.write_collection(well_node, str(ROOT / row / col / "well.json"))
...
def main() -> None:
    ...
    show(ozc.open_collection(str(ROOT / "collection.json"), max_depth=0))
    ...
    location = well_a1.attrs[ozc.WellAttribute]
    print(
